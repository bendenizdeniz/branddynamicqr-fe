    ...
    >
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="bg-gray-900 text-white px-6 py-2.5 rounded-xl hover:bg-black transition-all font-bold shadow-lg shadow-gray-100"
        >
          Filtrele
        </button>
      </div>
        ...
        createPortal(
          ...
          >
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 hover:bg-gray-50 font-medium transition-colors text-left"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 hover:bg-gray-50 font-medium border-t border-gray-50 transition-colors text-left"
            >
              <Edit2 size={16} className="text-blue-500" /> Düzenle
            </button>
            <button
              onClick={() => {
                if (confirm("Emin misiniz?")) setActiveMenuId(null);
              }}
              className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 font-bold border-t border-gray-50 transition-colors text-left"
            >
      ...
      <Modal
        ...
        title={modalMode === "create" ? "Yeni Ürün Ekle" : "Ürün Düzenle"}
      >
        <form onSubmit={handleSave} className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5 text-left">
              ...
              <select
                ...
                className="w-full border border-gray-200 bg-gray-50 rounded-xl p-3 outline-none focus:ring-2 focus:ring-blue-500/20 text-sm font-bold"
            ...
            <div className="space-y-1.5 text-left">
              ...
              <input
                required
                disabled={modalMode === "view"}
                className="w-full border border-gray-200 bg-gray-50 rounded-xl p-3 outline-none font-mono text-sm"
                value={formData.ext_id}
                onChange={(e) =>
                  setFormData({ ...formData, ext_id: e.target.value })
                }
              />
            </div>
            <div className="space-y-1.5 text-left">
              ...
              <input
                ...
                required
                disabled={modalMode === "view"}
                className="w-full border border-gray-200 bg-gray-50 rounded-xl p-3 outline-none font-bold text-green-600"
          ...
          <div className="pt-2 border-t border-gray-100">
            <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block text-left mb-3">
              Dil Bazlı İsimler
            </label>
            <div className="grid grid-cols-1 gap-3">
              <input
                ...
                value={formData.names.tr}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    names: { ...formData.names, tr: e.target.value },
                  })
                }
              />
              <input
          ...
          {modalMode !== "view" && (
            <button
              type="submit"
              disabled={isSaving}
              className="w-full bg-blue-600 text-white py-4 rounded-2xl font-bold flex justify-center items-center gap-2 shadow-lg shadow-blue-100 transition-all hover:bg-blue-700 active:scale-[0.98]"
            >
              {isSaving ? (
